         ...
         <div class="mt-fbt-top-box">
            ...
            <div class="mt-fbt-image-box">
               ...
               <?php foreach ($alternates_products_rand as $key => $value) {
                  ...
                  $image = wp_get_attachment_image_src($alternate_products->get_image_id())[0];
               ?>
            ...
            <div class="mt-fbt-price-box">
               ...
               <div class="mt-fbt-total-price">
                  ...
                  <span class="mt-fbt-price-label"><?php echo esc_html( $label_style_data['total_label'] ); ?></span>
                  ...
                  <span><?php echo $curreny_symbol; ?></span>

                  <span class="mt-fbt-price-ammount">
                     <?php echo number_format($current_product_totalprice, 2); ?>
                  </span>
                  <!-- <span class="mt-fbt-discount">  12454  </span> -->
               </div>
               ...
               <div class="mt-fbt-price-button">
                  ...
                  <a class="mt-fbt-button" href="<?php echo esc_url_raw(add_query_arg('add-to-cart', implode(',', $fbtProductIds))); ?>">
                     ...
                     <?php echo esc_html( $label_style_data['button_label'] ); ?>
                  </a>
         ...
         <div class="mt-fbt-items">
            ...
            <div class="mt-fbt-item">
               ...
               <?php if ( !empty( $current_sale_price ) && ($setting_data['pricing_method'] == 'sale_price' || $setting_data['pricing_method'] == 'regular_price')) { ?>
                  ...
                  <input class="mt-fbt-check-input" type="checkbox" id="" checked data-product_id="<?php echo $product_id; ?>" data-product_price="<?php echo number_format($current_sale_price, 2); ?>">
               ...
               <?php } else { ?>
                  ...
                  <input class="mt-fbt-check-input" type="checkbox" id="" checked data-product_id="<?php echo $product_id; ?>" data-product_price="<?php echo number_format($current_regular_price, 2); ?>">
            ...
            <?php foreach ($alternates_products_rand as $key => $value) { ?>
               ...
               <div class="mt-fbt-item">
                  ...
                  <?php if ($sale_price && $setting_data['pricing_method'] == 'sale_price') { ?>
                     ...
                     <input class="mt-fbt-check-input" type="checkbox" id="" checked data-product_id="<?php echo $value; ?>" data-product_price="<?php echo number_format($sale_price, 2); ?>">
                  ...
                  <?php } else { ?>
                     <input class="mt-fbt-check-input" type="checkbox" id="" checked data-product_id="<?php echo $value; ?>" data-product_price="<?php echo ($regular_price) ?  number_format($regular_price, 2) : number_format(0, 2); ?>"> <label class="mt-fbt-check-label" for=""><span><a target="_blank" href=" <?php echo esc_url( get_permalink( $alternate_products->get_id()) );?>"><?php echo $alternate_products->get_title(); ?></a></span>
